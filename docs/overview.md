...
- **Cache coverage**: how many of your pages are cached.
- **Cache map**: which URLs are cached and what they depend on.
...
Go to **HTML Cache** in the admin to see coverage and clear the cache.
