...
it('declares shipped html cache extension contributions instead of deferring them', function (): void {
    ...
    expect($contributionTraceability['deferredContributions'] ?? null)->toBe([])
        ...
        ->and(HtmlCacheAdminPagesContribution::compatibleCapellApiVersion())->toBe('^1.0')
        ->and(HtmlCacheDashboardFilamentWidgetsContribution::compatibleCapellApiVersion())->toBe('^1.0')
        ->and(HtmlCacheModelsContribution::compatibleCapellApiVersion())->toBe('^1.0')
        ->and(HtmlCacheFrontendRoutesContribution::compatibleCapellApiVersion())->toBe('^1.0')
        ->and(HtmlCacheStaleProcessingScheduleContribution::compatibleCapellApiVersion())->toBe('^1.0')
